...
🤖 Robotics Engineer | ROS2 | Python | Computer Vision  
📍 Passionate about building intelligent autonomous systems  

I specialize in developing robotic systems integrating perception, navigation, and AI-based decision-making. My focus areas include drone systems, humanoid robotics, and retail automation.
...
Developing an AI-powered supermarket assistant robot using **ROS2** and **NVIDIA Jetson**.
...
- Camera (human detection & tracking)
...
- Sensor fusion for safe operation
